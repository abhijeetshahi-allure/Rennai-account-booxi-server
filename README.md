...
**App proxy (Booxi API):** The app proxy requires a tunnel. Do **not** use `--use-localhost`; run `shopify app dev` with the default Cloudflare tunnel so `/apps/booxi/client` and `/apps/booxi/bookings` work.
